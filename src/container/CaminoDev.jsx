    ...
    <main className="caminoDev">
      ...
      <section className="caminoDev__author">
        <div className="caminoDev__author--card">
          <img src={fotoPerfil} alt="foto de perfil" title="foto de perfil" />
          <div>
            <h3>Escrito por: Anyelo Cruz</h3>
            <h3>Publicado: 14/05/2021</h3>
          </div>
        </div>
      </section>
      ...
      <section className="caminoDev__post">
        ...
        <p>
          ...
          {' '}
          Espero que espero que te haya gustado, y te lleves alguna lección de mi experiencia. Gracias por llegar hasta aquí, que tengas un buen día.
        </p>
      </section>
